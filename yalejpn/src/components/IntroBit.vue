...
const about = ref('紹介の事・目的')
const purpose = ref(
  'どうしてイェール大学についてのツアーを作りましたか？イェール大学は世界的に有名な大学です。 個人的には、イェール大学は特に日本においてもっともっと世界的な活動を行うことができると信じています。 ということで、期末の発表はイェール大学を紹介する動画を作って、発表したいと思います。その上に、サイトも作りたいと思います。'
)
</script>

<template>
  <section id="intro" class="-intro-container">
    <div class="-intro-wrapper -wpx">
      <div class="-intro-title">
        <h1 class="-abt-x">{{ about }}</h1>
      </div>
      <div class="-intro-x">
        <div class="y-gallery">
...
.-i1 {
  --img: url('@/assets/images/intro/murr.jpg');
}
...
.-i3 {
  --img: url('@/assets/images/intro/cc.jpg');
}
